<template>
    <div class="m-comments" v-if="comments.length">
        <slot name="header" :title="title"></slot>
        <div class="cmt_list">
            <div :key="item.commentId" class="cmt_item" v-for="item in finalComments">
                <div class="cmt_head">
                    <a :href="item.user.nicknameUrl" class="userphoto">
                ...
                <div class="cmt_wrap f-bd f-bd-btm">
                    <div class="cmt_header">
                        <div class="cmt_meta">
                            <span class="cmt_user">
                                <a :href="item.user.nicknameUrl" class="nickname">
